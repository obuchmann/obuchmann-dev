...
- **Avoid direct address (du/Sie) in German site copy Claude authors** — the general pages (About, Privacy, UI strings, disclaimers, and similar site-chrome text, as opposed to essay content sourced from Oliver's own vault drafts). Prefer impersonal phrasing: "Dies ist die englische Originalfassung" rather than "du liest hier die englische Originalfassung"; "was hier zu erwarten ist" rather than "was dich hier erwartet."
