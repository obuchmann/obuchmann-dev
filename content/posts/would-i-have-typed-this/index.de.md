---
title: "Würde ich das tippen?"
subtitle: "AI-Antworten sind ausführlich, weil das Modell seine eigenen Worte zum Weiterarbeiten braucht - nicht weil der Leser sie braucht."
date: 2026-08-26
slug: would-i-have-typed-this
description: "Die AI gibt beim Antworten mehr Context zurück, als der Empfänger braucht, weil die Ausführlichkeit für die Maschine funktional ist, nicht für den Leser. Ein einfacher Test, um diese Lücke vor dem Weiterleiten zu schließen - und warum die Lösung dieselbe ist, die man von der Gegenrichtung schon kennt."
tags: [agentic-engineering, knowledge-work, knowledge-management]
---

Es gibt eine Frage, die unangenehm zuverlässig funktioniert: **Würde ich das tippen, wenn ich es dieser Person selbst schreiben müsste?**
...
Der Handoff an ein Modell und der Handoff an einen Menschen sind zwei verschiedene Grenzen. Wir behandeln sie gleich.
...
Und dann nimm es als festes Kriterium auf. So wie du „keine Grundlagenerklärungen" oder „maximal zehn Zeilen" ins Prompt schreibst, gehört da hinein: für wen das ist. Wer das einmal zum Bestandteil seiner Prompts macht, muss hinterher nichts mehr von Hand kürzen.

Damit schließt sich der Kreis: **Um den zweiten Fehler von der AI beheben zu lassen, musst du den ersten vermeiden.** Zu wenig Context rein und zu viel Context raus sind nicht zwei Probleme. Es ist eines, zweimal.
